...
#+BEGIN_SRC R
  ...
  kagoshima <- fmtcatch(fname2[[6]], spcs = spcs)

  ngs      <- fmtcatch.nagasaki(fname2[[2]], "katakuchi")
  tbn      <- fmtcatch.nagasaki(fname2[[3]], "katakuchi")
  nr       <- fmtcatch.nagasaki(fname2[[4]], "katakuchi")
  kjk      <- fmtcatch.nagasaki(fname2[[5]], "katakuchi")
