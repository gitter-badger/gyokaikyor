...
#+END_SRC
*** テスト/ 整形
#+BEGIN_SRC  :tangle tests/testthat/test_fmtbl.R
...
#+BEGIN_SRC R :tangle R/fmtbl.R
  ...
  path <- "data.git/漁海況/2018年3月/各県資料/鹿児島県/体長組成(H29年度).xlsx"
  spcs <- "katakuchi"
  ...
  kagoshima <- fmtbl.kagoshima(path, spcs, nest = TRUE)
  kagoshima
  kagoshima <- fmtbl.kagoshima(path, spcs, nest = FALSE)
  kagoshima
#+END_SRC
